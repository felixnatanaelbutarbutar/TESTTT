  ...
  <div class="container">
      <div class="row justify-content-center">
          <div class="col-8">
              <div class="card">
                  <div class="card-body">
                    <form action="/updatedonasi/{{ $data->id }} " method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Dasar Memberi </label>
                            <textarea class="form-control" name="jenis" id="exampleInputEmail1" aria-describedby="emailHelp">{{ $data->jenis }}</textarea>   
                        </div>  
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Nama Pemberi</label>
                            <input type="text" class="form-control" id="exampleInputEmail1" name="nama" value="{{ $data->nama }}" aria-describedby="emailHelp">
                    
                        </div>
                        <div class="mb-3">
                          <label for="exampleInputPassword1" class="form-label">Jumlah</label>
                          <input type="number" class="form-control"name="jumlah" value="{{ $data->jumlah }}" id="exampleInputPassword1">
                        </div>
